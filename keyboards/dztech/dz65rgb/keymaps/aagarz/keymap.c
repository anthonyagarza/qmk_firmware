...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_65_ansi(
        ...
        KC_LGUI,        KC_LCTL, KC_LALT,                            KC_SPC,                    KC_RALT, MO(_FN),   KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [_FN] = LAYOUT_65_ansi(
        ...
        _______,        COLEMAK, QWERTY,                            _______,                   _______, _______, _______, KC_MPRV, KC_VOLD, KC_MNXT
    )
};
